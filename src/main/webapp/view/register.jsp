...
<div class="container" style="padding: 20px">
    ...
    <form:form method="post" action="addPatient.html" modelAttribute="appUser" style="padding-top: 20px">
        ...
        <div class="form-row">
            <div class="col">
                <div class="form-group">
                    <form:label path="firstName"><label for="firstName"><spring:message code="firstName"/></label></form:label>
        ...
        <div class="form-group">
            <form:label path="phoneNumber"><label for="phoneNumber"><spring:message code="phoneNumber"/></label></form:label>
